...
const projects = [
    ...
    },
    {
        ...
        tags: ["Next.js", "React.js", "Node.js", "Supabase", "Tailwind CSS", "Vercel"],
    ...
    },
    {
        ...
        tags: ["Flutter", "React.js", "Node.js", "Supabase", "Payment Gateway"],
    ...
    },
    {
        ...
        tags: ["React.js", "Supabase", "Paystack"],
    ...
    },
    {
        ...
        tags: ["Next.js", "Supabase", "Payment API", "Google Maps API", "Amadeus API"],
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto bg-card">
                            <div className="p-8 lg:p-10 space-y-8">
                                ...
                                {/* APK Request Banner */}
                                {project.apkAvailable && (
                                    <a
                                        href={`https://wa.me/233248651340?text=${encodeURIComponent("Hi Raffat! I'd like to request the APK(s) for the Logistics Construction Sales Platform. Please share the download link.")}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center gap-3 p-4 rounded-2xl bg-green-500/10 border border-green-500/30 hover:bg-green-500/20 transition-colors group/apk"
                                    >
                                        <div className="w-10 h-10 rounded-xl bg-green-500/20 flex items-center justify-center shrink-0">
                                            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-green-500" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-sm font-black text-green-600 dark:text-green-400">APKs available on request</p>
                                            <p className="text-xs text-muted-foreground">Tap to message me on WhatsApp for the download link</p>
                                        </div>
                                        <Zap className="w-4 h-4 text-green-500 opacity-0 group-hover/apk:opacity-100 transition-opacity" />
                                    </a>
                                )}
